...
def main():
    ...
    for idx, abstract in enumerate(abstracts):
        ...
        if not doc_relationships:
            ...
            doc_relationships = [{"src": fallback_text, "relation": "no_relationship", "tgt": fallback_text, "doc_id": doc_id}]
    ...
    missing_entities = set(abs_ids) - entity_doc_ids
    missing_relationships = set(abs_ids) - relationship_doc_ids
